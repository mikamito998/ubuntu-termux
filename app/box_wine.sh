...
apt update
apt install -y gpg xz-utils software-properties-common build-essential --no-install-recommends --no-install-suggests
...
wget https://Pi-Apps-Coders.github.io/box64-debs/box64.list -O /etc/apt/sources.list.d/box64.list
...
apt update && sudo apt install box64-android -y
apt-get install mesa-vdpau-drivers

# Install Box86 pi-apps-coders
wget https://Pi-Apps-Coders.github.io/box86-debs/box86.list -O /etc/apt/sources.list.d/box86.list
...
apt update && sudo apt install box86-android:armhf -y
