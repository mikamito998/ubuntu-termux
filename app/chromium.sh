...
sudo apt install -y software-properties-common apt-utils exo-utils xz-utils gnupg gnupg1 gnupg2 build-essential libcurl4-openssl-dev libssl-dev libjansson-dev automake autotools-dev libboost-all-dev python3-pip aptitude --no-install-recommends --no-install-suggests
