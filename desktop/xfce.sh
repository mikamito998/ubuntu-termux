...
apt install -y xfce4 xfce4-goodies nautilus parole ristretto xarchiver gdebi gedit xfce4-taskmanager xfce4-screenshooter xfmpc gnome-terminal --no-install-recommends --no-install-suggests
